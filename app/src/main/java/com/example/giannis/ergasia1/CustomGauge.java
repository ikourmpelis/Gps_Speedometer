...
public class CustomGauge extends View {
    ...
    public CustomGauge(Context context, AttributeSet attrs) {
        ...
        setEndValue(a.getInt(R.styleable.CustomGauge_gaugeEndValue, 260));

        // pointer size and color
        setPointSize(a.getInt(R.styleable.CustomGauge_gaugePointSize, 2));
        setPointStartColor(a.getColor(R.styleable.CustomGauge_gaugePointStartColor, ContextCompat.getColor(context, android.R.color.holo_red_dark)));
        setPointEndColor(a.getColor(R.styleable.CustomGauge_gaugePointEndColor, ContextCompat.getColor(context, android.R.color.holo_red_dark)));

        // divider options
        int dividerSize = a.getInt(R.styleable.CustomGauge_gaugeDividerSize, 1);

        int dividerStep = a.getInt(R.styleable.CustomGauge_gaugeDividerStep, 1);
        setDividerDrawFirst(a.getBoolean(R.styleable.CustomGauge_gaugeDividerDrawFirst, true));
        setDividerDrawLast(a.getBoolean(R.styleable.CustomGauge_gaugeDividerDrawLast, false));
